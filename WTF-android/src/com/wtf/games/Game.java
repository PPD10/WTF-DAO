...
import com.wtf.entities.infos.MaxScore;
...
public class Game {
	...
	private static final String MAXSCORE_KEY = "maxScore";
	...
	public Game(CharacterEnum characterName, LevelEnum levelName) {
		...
		infos.put(MAXSCORE_KEY, new MaxScore());
	...
	public MaxScore getMaxScore() {
		return (MaxScore) infos.get(MAXSCORE_KEY);
	}
